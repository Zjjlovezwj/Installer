...
On Error Resume Next
    ...
    Option1.Caption = GetStringByID("ID_13")
    Option2.Caption = GetStringByID("ID_14")
    Label1.Caption = GetStringByID("ID_15")
    Label2.Caption = GetStringByID("ID_16")
    Text1.Text = GetStringByID("ID_17")
