...
Begin VB.Form frmComplete 
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "正在完成 [ProductName] [Wizard]"
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   15
         Charset         =   134
...
On Error Resume Next
    ...
    Label1.Caption = GetStringByID("ID_30")
    Label2.Caption = GetStringByID("ID_28")
    Check1.Caption = GetStringByID("ID_31")
    Command1.Caption = GetStringByID("ID_7")
    Command2.Caption = GetStringByID("ID_29")
...
On Error Resume Next
    ...
    si.cb = Len(si)
    retVal = CreateProcess( _
        vbNullString, _
        frmFolder.Text1.Text & GetSetting(configPath, ID_MainAppPath), _
        0, 0, False, 0, 0, vbNullString, si, pi)
    
    If retVal = 0 Then
        MsgBox GetStringByID("ID_37"), vbExclamation, GetStringByID("ID_1")
    End If
On Error GoTo 0
End Sub
