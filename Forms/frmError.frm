...
Begin VB.Form frmError 
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "[ProductName] 的安装被中断。您的系统没有被修改。要稍后安装此程序，请再运行安装程序。"
      Height          =   975
      Left            =   2760
      TabIndex        =   4
      Top             =   1920
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "[ProductName] [Wizard]过早地结束"
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   15
         Charset         =   134
...
On Error Resume Next
    ...
    Label1.Caption = GetStringByID("ID_26")
    Label2.Caption = GetStringByID("ID_27")
    Label3.Caption = GetStringByID("ID_28")
